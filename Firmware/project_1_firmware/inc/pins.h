...
// setup a pin macro
#define P_LED_task1 P0_4
// setup an analogin pin. Don't know the configuration of mcu, random pin selected
#define P_RES_task2 P0_10
