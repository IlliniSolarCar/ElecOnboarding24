...
libraries/fs/fat/ChaN/%.o: ../libraries/fs/fat/ChaN/%.cpp libraries/fs/fat/ChaN/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-libraries-2f-fs-2f-fat-2f-ChaN

clean-libraries-2f-fs-2f-fat-2f-ChaN:
	-$(RM) ./libraries/fs/fat/ChaN/ccsbcs.d ./libraries/fs/fat/ChaN/ccsbcs.o ./libraries/fs/fat/ChaN/diskio.d ./libraries/fs/fat/ChaN/diskio.o ./libraries/fs/fat/ChaN/ff.d ./libraries/fs/fat/ChaN/ff.o

.PHONY: clean-libraries-2f-fs-2f-fat-2f-ChaN
