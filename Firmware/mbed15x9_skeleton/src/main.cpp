#include "libraries/mbed/targets/cmsis/TARGET_NXP/TARGET_LPC176X/lpc17xx.h"
...
int main (void)
{
	...
	LPC_GPIO0->FIODIR |= 1 << 5;			// P0.5 = Outputs
	LPC_GPIO0->FIOCLR = 1 << 5;			// Turn-OFF LED

	//Loop LED
	while(1)
	{
		LPC_GPIO0->FIOSET = 1 << 5;		// Turn-ON LED
