...
AnalogIn potentiometer(P_POT);// PROJECT 2 - You can instantiate your AnalogIn object here
...
DigitalOut led5(P_LED5);// PROJECT 1 - You can instantiate your DigitalOut object here
