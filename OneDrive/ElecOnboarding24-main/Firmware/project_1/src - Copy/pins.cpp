...
AnalogIn Potentiometer;// PROJECT 2 - You can instantiate your AnalogIn object here
...
DigitalOut heartbeat(P_heartbeat);// PROJECT 1 - You can instantiate your DigitalOut object here
