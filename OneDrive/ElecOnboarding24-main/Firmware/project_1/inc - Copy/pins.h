...
#define P_LED3 P0_6
#define P_LED4 P0_7
#define P_heartbeat P0_4  // PROJECT 1 - You can define a pin macro here
...
extern DigitalOut heartbeat;// PROJECT 1 - You can declare a DigitalOut object here

/*
 * BOARD SPECIFIC PINS
 */

extern AnalogIn Potentiometer P0_4; // PROJECT 2 - You can declare a AnalogIn object here
